-- Import file for hosting environments (Namecheap, etc.)
-- Create tables + sample data for Nước Hoa TMH
-- Note: Database must be created in cPanel first
...
INSERT INTO customers (full_name, email, phone, password_hash, role) VALUES
('Administrator', 'admin@tmh.local', '0900000000', '$2y$10$ZDgbOOYlbRzeiLtIoHEat.wCTTjL/aL2emwVKHT4Q.JBfdSG19ROO', 'admin');

INSERT INTO products (name, description, price, old_price, promo_text, category_name, brand_name, color_name, size_name, scent_type, image_url, gallery_urls, video_url, is_active) VALUES
